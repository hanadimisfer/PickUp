...
public class OrderCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driver= (TextView) findViewById(R.id.drivenT1);
    ...
    public void veiwOrder(){
        Cursor c = db.rawQuery("SELECT p.Location, p.Destination, p.Price,p.Size, d.D_Fname FROM Package p INNER JOIN Driver d ON p.DID=d.DID WHERE Cid='"+id+"'", null);
        if(c.getCount()==0) {
        ...
        driver.setText(bufferd.toString());
    }
    ...
    public void backB(View v){
        //chanage
        Intent nPage= new Intent(OrderCustomer.this , ClientDashboard.class);
